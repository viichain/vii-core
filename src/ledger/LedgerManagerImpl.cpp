...
const uint32_t LedgerManager::GENESIS_LEDGER_BASE_RESERVE = 50;
const uint32_t LedgerManager::GENESIS_LEDGER_MAX_TX_SIZE = 100;
const int64_t LedgerManager::GENESIS_LEDGER_TOTAL_COINS = 204081224490000000;
...
LedgerManagerImpl::valueExternalized(LedgerCloseData const& ledgerData)
{
    CLOG(INFO, "Ledger")
        ...
        << viiValueToString(mApp.getConfig(), ledgerData.getValue()) << "]";
    ...
    mApp.postOnMainThreadWithDelay(
        [&] {
            ...
            CLOG(INFO, "Ledger")
                ...
                << viiValueToString(mApp.getConfig(), lcd.getValue())
                << "]";
            closeLedger(lcd);
...
LedgerManagerImpl::closeLedger(LedgerCloseData const& ledgerData)
{
        ...
        mApp.getConfig().LEDGER_PROTOCOL_VERSION)
    {
        ...
        CLOG(ERROR, "Ledger") << UPGRADE_VII_CORE;
