...
TrustLineWrapper::NonIssuerImpl::addBalance(LedgerTxnHeader const& header,
                                            int64_t delta)
{
    return viichain::addBalance(header, mEntry, delta);
}
...
{
    return viichain::getBuyingLiabilities(header, mEntry);
}
...
TrustLineWrapper::NonIssuerImpl::getSellingLiabilities(
    LedgerTxnHeader const& header)
{
    return viichain::getSellingLiabilities(header, mEntry);
}
...
{
    return viichain::addBuyingLiabilities(header, mEntry, delta);
}
...
TrustLineWrapper::NonIssuerImpl::addSellingLiabilities(
    LedgerTxnHeader const& header, int64_t delta)
{
    return viichain::addSellingLiabilities(header, mEntry, delta);
}

bool
TrustLineWrapper::NonIssuerImpl::isAuthorized() const
{
    return viichain::isAuthorized(mEntry);
}
...
{
    return viichain::getAvailableBalance(header, mEntry);
}
...
TrustLineWrapper::NonIssuerImpl::getMaxAmountReceive(
    LedgerTxnHeader const& header) const
{
    return viichain::getMaxAmountReceive(header, mEntry);
}
