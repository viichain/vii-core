...
- [vii-core administration](software/admin.md)
- [Architecture](architecture.md)
- [Key Concepts](https://www.vii.vip/developers/guides/)
...
* **Herder** is responsible for interfacing between SCP and the rest of
  `vii-core`. Herder provides SCP with concrete implementations of the
